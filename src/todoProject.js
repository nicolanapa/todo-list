...
class Project {
	//CREA IL PROGETTO E MANDA IL NOME NELL'ARRAY
...
function defultProject() {
	...
	ToDoDefault = new ToDo("Andare a fare la spesa", "Comprare cibario", "Latte", "2024-02-10", "2", "default");
	ToDoDefault = new ToDo("Andare a fare la spesa", "Comprare cibario", "Latte", "2024-02-10", "3", "default");
	ToDoDefault = new ToDo("Andare a fare la spesa", "Comprare cibario", "Latte", "2024-02-10", "4", "default");
	ToDoDefault = new ToDo("Andare a fare la spesa", "Comprare cibario", "Latte", "2024-02-10", "5", "default");
...
export { toDoArray, ToDo, Project, projectNameArray, populateToDo, populateProject, resetToDoArray };
